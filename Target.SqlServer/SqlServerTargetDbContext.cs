...
{
    public partial class SqlServerTargetDbContext : DbContext, ITargetDbContext
    {
        public SqlServerTargetDbContext(DbContextOptions<SqlServerTargetDbContext> options)
            : base(options)
        {
        }
