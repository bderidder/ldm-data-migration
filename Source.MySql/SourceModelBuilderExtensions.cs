...
namespace LaDanse.Source.MySql
{
    public static class SourceModelBuilderExtensions
    {
        public static void ApplyAllSourceConfigurations(this ModelBuilder modelBuilder)
        {
            ...
            var ret = typeof(SourceDbContext).Assembly
                .GetTypes()
